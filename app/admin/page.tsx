  ...
  nb: {
    ...
    links: [
      ...
      },
      {
        ...
        description: "Se tidligere kjøringer, rapporter og pipeline-status fra brukervisningen.",
        status: "Arkiv",
      },
    ],
  },
  nn: {
    ...
    links: [
      ...
      },
      {
        ...
        href: "/mine",
        eyebrow: "Rapportarkiv",
        description: "Sjå tidlegare køyringar, rapportar og pipeline-status frå brukarvisinga.",
        status: "Arkiv",
      },
    ],
  },
