 ...
 * Konstruktør A og Konstruktør B. Ein partialfaktor er ikkje ein "metode".
 *
...
export const EC2 = {
  ...
  // Begge konstruktørane OG ξ_lim-sjekken skal bruke denne normaliseringa.
...
const NA_BASIS_HEADER =
  "NA-GRUNNLAG — AUTORITATIVE VERDIAR (gjeld både Konstruktør A og Konstruktør B)\n" +
